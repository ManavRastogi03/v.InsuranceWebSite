            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="hidden lg:flex lg:space-x-8 lg:items-center lg:flex-1 lg:justify-center">
                        ...
                        <div
                            className="relative"
                            onMouseEnter={handleMouseEnterInsurance}
                            onMouseLeave={handleMouseLeaveInsurance}
                        >
                            <NavLink
                                to="#"
                                className="py-2 px-4 text-gray-700 hover:text-green-300"
                            >
                                Insurance
                            </NavLink>
                        ...
                        <div
                            className="relative"
                            onMouseEnter={handleMouseEnterAdvisory}
                            onMouseLeave={handleMouseLeaveAdvisory}
                        >
                            <NavLink
                                to="#"
                                className="py-2 px-4 text-gray-700 hover:text-green-300"
